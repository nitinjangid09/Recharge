...
const styles = StyleSheet.create({
  ...
  serviceBannerText: { fontSize: 18, fontWeight: "700", color: Colors.black || "#1A1A2E" },
  serviceBannerSubText: { fontSize: 11, color: "#6B7280", marginTop: 4, lineHeight: 16 },

  fieldsWrap: { marginTop: 6 },
  sectionTitle: { fontSize: 11, fontWeight: "700", color: Colors.primary, letterSpacing: 0.8, marginBottom: 14, borderBottomWidth: 1, borderBottomColor: Colors.lightGray || "#E5E7EB", paddingBottom: 8 },
  ...
  billTitle: { fontSize: 16, fontWeight: "700", color: Colors.black || "#1A1A2E", marginBottom: 14, borderBottomWidth: 1, borderBottomColor: "#F3F4F6", paddingBottom: 8 },
  ...
  billValue: { fontSize: 14, fontWeight: "600", color: "#1A1A2E", flex: 1, textAlign: "right", marginLeft: 10 },
  billAmountRow: { marginTop: 8, paddingTop: 12, borderTopWidth: 1, borderTopColor: "#F3F4F6" },
  billAmountLabel: { fontSize: 14, fontWeight: "700", color: "#1A1A2E" },
  billAmountValue: { fontSize: 18, fontWeight: "800", color: "#10B981" },
  ...
  payOptionLabel: { fontSize: 14, fontWeight: "600", color: "#6B7280", flex: 1, paddingRight: 8 },
  payOptionLabelSelected: { color: Colors.primary },
  payOptionValue: { fontSize: 15, fontWeight: "700", color: "#1A1A2E" },
  ...
  rsPrefix: { fontSize: 16, fontWeight: "700", color: "#1A1A2E", marginRight: 8 },
  customAmountInput: {
    flex: 1, fontSize: 16, fontWeight: "600", color: "#1A1A2E", paddingVertical: 4
  },
});
