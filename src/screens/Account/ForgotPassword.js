...
const ForgotPasswordScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <HeaderBar title="Forgot Password" onBack={() => navigation?.goBack()} />
        ...
        >
          ...
          <View style={styles.pwHead}>
            <View style={styles.pwHeadIc}>
              <Icon name="email-outline" size={20} color={Colors.amber} />
            </View>
            <Text style={styles.pwHeadTitle}>Forgot Password</Text>
