...
const loaderStyles = StyleSheet.create({
  ...
  innerRing: {
    ...
    borderRadius: 18,
    borderWidth: 3,
    borderColor: (Colors.finance_accent || "#d4b06a") + "88",
...
const ddStyles = StyleSheet.create({
  ...
  triggerTxt: { fontSize: 15, color: Colors.black || "#1A1A2E", flex: 1 },
  placeholder: { color: "#B0B8CC" },
  chevron: { fontSize: 20, color: "#9CA3AF", marginLeft: 10, transform: [{ rotate: "90deg" }] },
  ...
  searchInput: { flex: 1, fontSize: 15, color: Colors.black || "#1A1A2E", paddingVertical: 0, height: 20 },
  ...
  itemTxt: { flex: 1, fontSize: 14, color: Colors.black || "#1A1A2E", fontWeight: "500" },
  ...
  emptyTxt: { fontSize: 13, color: "#B0B8CC" },
});
...
const calStyles = StyleSheet.create({
  ...
  card: { width: "100%", backgroundColor: "#FFF", borderRadius: 22, overflow: "hidden", elevation: 20 },
  ...
  cellTxtSelected: { color: "#FFF", fontFamily: Fonts.Bold },
  cellTxtToday: { color: Colors.primary, fontFamily: Fonts.Bold },
  cellTxtDisabled: { color: "#9CA3AF" },
  yearList: { maxHeight: 250 },
  yearItem: { height: 44, justifyContent: "center", alignItems: "center", borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "#E5E7EB" },
  ...
  footer: { flexDirection: "row", justifyContent: "flex-end", paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: "#E5E7EB", gap: 12 },
  cancelBtn: { paddingHorizontal: 16, paddingVertical: 8 },
  cancelTxt: { fontSize: 14, color: "#6B7280", fontFamily: Fonts.SemiBold },
...
const styles = StyleSheet.create({
  ...
  serviceBannerText: { fontSize: 18, fontFamily: Fonts.Bold, color: Colors.black || "#1A1A2E" },
  serviceBannerSubText: { fontSize: 11, fontFamily: Fonts.Regular, color: "#6B7280", marginTop: 4, lineHeight: 16 },

  fieldsWrap: { marginTop: 6 },
  sectionTitle: { fontSize: 11, fontFamily: Fonts.Bold, color: Colors.primary, letterSpacing: 0.8, marginBottom: 14, borderBottomWidth: 1, borderBottomColor: Colors.lightGray || "#E5E7EB", paddingBottom: 8 },
  inputBlock: { marginBottom: 18 },
  inputLabel: { fontSize: 13, fontFamily: Fonts.SemiBold, color: Colors.black || "#1A1A2E", marginBottom: 7 },
  req: { color: "#E53935" },
  textInput: { borderWidth: 1, borderColor: Colors.lightGray || "#DDE1EC", borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14, backgroundColor: Colors.white || "#FFF", fontSize: 15, color: Colors.black || "#1A1A2E", elevation: 2 },
  ...
  errorBox: { marginVertical: 18, padding: 16, backgroundColor: "#FFF3F3", borderRadius: 12, borderWidth: 1, borderColor: "#FFCDD2", alignItems: "center" },
  ...
  retryTxt: { color: "#FFF", fontSize: 13, fontFamily: Fonts.SemiBold },
  ...
  payBtnTxt: { color: Colors.white || "#FFF", fontSize: 16, fontFamily: Fonts.Bold, letterSpacing: 0.3 },
  payBtnSub: { color: "rgba(255,255,255,0.7)", fontSize: 11, marginTop: 3 },

  billDetailsCard: { backgroundColor: Colors.white || "#FFF", padding: 18, borderRadius: 16, borderWidth: 1, borderColor: "#E5E7EB", marginTop: 18, elevation: 3, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  billTitle: { fontSize: 16, fontFamily: Fonts.Bold, color: Colors.black || "#1A1A2E", marginBottom: 14, borderBottomWidth: 1, borderBottomColor: "#F3F4F6", paddingBottom: 8 },
  billRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 7 },
  billLabel: { fontSize: 13, fontFamily: Fonts.Regular, color: "#6B7280" },
  billValue: { fontSize: 14, fontFamily: Fonts.SemiBold, color: "#1A1A2E", flex: 1, textAlign: "right", marginLeft: 10 },
  billAmountRow: { marginTop: 8, paddingTop: 12, borderTopWidth: 1, borderTopColor: "#F3F4F6" },
  billAmountLabel: { fontSize: 14, fontFamily: Fonts.Bold, color: "#1A1A2E" },
  billAmountValue: { fontSize: 18, fontFamily: Fonts.Bold, color: "#10B981" },

  payOption: { flexDirection: "row", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "#F3F4F6", marginBottom: 4 },
  payOptionSelected: { backgroundColor: "transparent" },
  radioOut: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: "#D1D5DB", justifyContent: "center", alignItems: "center", marginRight: 12 },
  ...
  payOptionLabel: { fontSize: 14, fontFamily: Fonts.SemiBold, color: "#6B7280", flex: 1, paddingRight: 8 },
  payOptionLabelSelected: { color: Colors.primary },
  payOptionValue: { fontSize: 15, fontFamily: Fonts.Bold, color: "#1A1A2E" },
  ...
  rsPrefix: { fontSize: 16, fontFamily: Fonts.Bold, color: "#1A1A2E", marginRight: 8 },
  customAmountInput: {
    flex: 1, fontSize: 16, fontFamily: Fonts.SemiBold, color: "#1A1A2E", paddingVertical: 4
  },
});

const alertStyles = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "center", alignItems: "center", padding: 30 },
  card: { backgroundColor: "#FFF", borderRadius: 24, padding: 25, width: "100%", alignItems: "center", elevation: 20, shadowColor: "#000", shadowOpacity: 0.2, shadowRadius: 15 },
  iconWrap: { width: 60, height: 60, borderRadius: 30, backgroundColor: "#FEF2F2", alignItems: "center", justifyContent: "center", marginBottom: 15 },
  iconWrapSuccess: { backgroundColor: "#F0FDF4" },
  icon: { fontSize: 30 },
  title: { fontSize: 18, fontFamily: Fonts.Bold, color: "#111827", marginBottom: 8, textAlign: "center" },
  message: { fontSize: 14, fontFamily: Fonts.Regular, color: "#4B5563", textAlign: "center", lineHeight: 20, marginBottom: 20 },
  btn: { backgroundColor: Colors.finance_accent || Colors.primary, paddingVertical: 12, paddingHorizontal: 35, borderRadius: 14, elevation: 4 },
  btnTxt: { color: "#FFF", fontSize: 15, fontFamily: Fonts.Bold },
});