          ...
          <Animated.View style={{ transform: [{ scale: btnScale }], marginTop: vs(20) }}>
            ...
            >
              {loading ? (
                ...
                <Text style={[styles.buttonText, (!mobileNumber || !bank) && { color: Colors.slate_500 }]}>Proceed to Verify  →</Text>
              )}
            </TouchableOpacity>
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  deviceInfoTxt: {
    fontFamily: Fonts.Medium, color: Colors.gray, fontSize: rs(11), fontWeight: "500", lineHeight: rs(17),
  },
