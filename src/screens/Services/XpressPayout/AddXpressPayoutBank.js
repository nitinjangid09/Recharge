...
const styles = StyleSheet.create({
  ...
  uploadArea: { height: rs(80), backgroundColor: Colors.cardbg, borderRadius: rs(18), borderWidth: 1.5, borderColor: Colors.input_border, borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center', gap: rs(5) },
  uploadTxt: { fontSize: rs(12), fontFamily: Fonts.Medium, color: Colors.text_secondary },
  imagePreviewContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.cardbg, borderRadius: rs(18), padding: rs(12), borderWidth: 1, borderColor: Colors.input_border, gap: rs(15) },
