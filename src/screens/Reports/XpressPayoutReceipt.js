...
export default function XpressPayoutReceipt({ route, navigation }) {
  ...
  const handleShare = async () => {
    try {
      const message = `Xpress Payout Receipt\n\nReference ID: ${txn.referenceId || txn.payoutId}\nBeneficiary: ${txn.beneficiaryName}\nAmount: ₹${txn.amount}\nStatus: ${txn.status}\nDate: ${new Date(txn.createdAt).toLocaleString()}\nBank: ${txn.bankAccount}\nIFSC: ${txn.ifsc}`;
  ...
  return (
    <SafeAreaView style={styles.container}>
      <HeaderBar title="Xpress Payout Receipt" onBack={() => navigation.goBack()} />
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailsCard}>
          ...
          <ReceiptRow label="Phone" value={txn.beneficiaryPhone || 'N/A'} icon="phone-outline" />
