...
const FST = StyleSheet.create({
  ...
  resetTxt: { fontSize: rs(12), fontFamily: Fonts.Bold, color: Colors.gold },
  ...
  navTxtActive: { color: Colors.gold, fontFamily: Fonts.Bold },
  ...
  optTxtActive: { color: Colors.gold, fontFamily: Fonts.Bold },
